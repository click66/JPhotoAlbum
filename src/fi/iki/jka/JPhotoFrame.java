...
public class JPhotoFrame extends JFrame
    ...
    private JPhotoActionsInterface jPhotoActions = null;
    ...
    public JPhotoFrame(String frameName, JPhotoCollection photos, JPhotoList list) throws Exception
    {
        this.photos = photos;
        this.list = list;
    }
    ...
    protected void init(String frameName, JPhotoCollection photos) throws Exception {
        ...
        fullViewPanel.setTransform(transform);x
        transform.setParentAndPanel(this, fullViewPanel);
        transform.startEditing();
        */
    }

    public void setjPhotoActions(JPhotoActionsInterface jPhotoActions)
    {
        this.jPhotoActions = jPhotoActions;
    }
    ...
    public void actionPerformed(ActionEvent event) {
        ...
        if (cmd.equals(JPhotoMenu.A_NEW) || cmd.equals(JPhotoMenu.A_OPEN)) {
            ...
            jPhotoActions.slideShow(photos, list, 5000);
        }
        else if (cmd.equals(JPhotoMenu.A_SLIDESHOW_FAST)) {
            jPhotoActions.slideShow(photos, list, 100);
        }
    ...
    */
    ...
    public static void main(String args[]) throws Exception {
        ...
        if (frame != null) {
            frame.setjPhotoActions(new JPhotoActions(frame));
        }
    }
}
